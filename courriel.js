...
function composerMessage()
{
 var mybody = document.getElementById("center");
  ...
  var x = '<table id="nouveau"><tbody><tr><td>Destinataire</td><td><input type="text"></td></tr><tr><td>Objet</td><td><input type="text"></td>'+
...
function ajouterContact()
{
 var mybody = document.getElementById("center");
  ...
  var x = '<table id="nouveau"><tbody><tr><td>Nom</td><td><input type="text"></td></tr><tr><td>Prenom</td><td><input type="text"></td>'+
